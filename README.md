...
## Botones-básicos-tailwind

Ejemplo de botones básicos creados con HTML y [Tailwind CSS](https://tailwindcss.com/) los cuales lo puedes utilizar como tu lo prefieras.

## Uso

Lo primero que tienes que hacer es tener instalado Tailwind en tu proyecto, si no sabes como? tranquilo no te preocupes que la instalación es super fácil, aca te dejo el link con la documentación oficial [Leer mas](https://tailwindcss.com/docs/installation), luego de tener instalado Tailwind en tu proyecto, lo único que tienes que hacer, que es aun mas fácil es solo copiar y pegar, y ya tendrás un componente creado con HTML y Tailwindcss.
